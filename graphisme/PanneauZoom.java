...
public class PanneauZoom extends Panneau {
  ...
  public Image [] chargerTIB(){
    ...
    if(!initialisationFX && !Main.getGarderLesGraphismesTourné()){tournerLesFlèches();initialisationFX=true;}
    ...
    tIB[3] = image.getImage("temporaire/flèche1").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    //tourner +90°
    tIB[4] = image.getImage("centrer").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    tIB[5] = image.getImage("temporaire/flèche2").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    //tourner -90°
    tIB[6] = image.getImage("temporaire/flèche3").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    //tourner +180°
  ...
  public Image [] chargerTIB2(Pixel pi){
    ...
    if(!initialisationFX){
      ...
      for (String nom : ts ) {
        ...
        img.sauvegarder("temporaire/"+nom);
      }
      if(!Main.getGarderLesGraphismesTourné()){tournerLesFlèches("temporaire/fleche");}
      initialisationFX=true;
    }
    tIB[0] = image.getImage("temporaire/moins").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    tIB[1] = image.getImage("temporaire/fleche").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    tIB[2] = image.getImage("temporaire/plus").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    tIB[3] = image.getImage("temporaire/flèche1").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    //tourner +90°
    tIB[4] = image.getImage("temporaire/centrer").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    tIB[5] = image.getImage("temporaire/flèche2").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    //tourner -90°
    tIB[6] = image.getImage("temporaire/flèche3").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    //tourner +180°
    tIB[7] = image.getImage("temporaire/centrer").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    tIB[8] = image.getImage("temporaire/centrer").getScaledInstance(tailleBouton,tailleBouton ,Image.SCALE_SMOOTH);
    return tIB;
  }
  public void tournerLesFlèches(String nom){
    Img f = new Img(nom);
    Img f1 = f.tourner(1);
    Img f2 = f.tourner(3);
    Img f3 = f.tourner(2);
    f1.sauvegarde("temporaire/flèche1.png");
    f2.sauvegarde("temporaire/flèche2.png");
    f3.sauvegarde("temporaire/flèche3.png");
  }public void tournerLesFlèches(){ tournerLesFlèches("fleche");}

...
public class arbo {
  ...
  public static boolean arborécenceIntacte(){
    ...
    File imageFormiko = new File("data/imageFormiko");
    if(!imageFormiko.exists() || !imageFormiko.isDirectory()){ return false;}
    ...
    String listi [] = imageFormiko.list();
    if(listi.length<nbrDImage){return false;}
    String listl [] = imageFormiko.list();
    if(listl.length<nbrDeLangue){return false;}
    //data/imageFormiko/temporaire.
    File temporaire = new File("data/imageFormiko/temporaire");
  ...
  public static void réparationArboréscence(){
    ...
    File imageFormiko = new File("data/imageFormiko");
    if(!imageFormiko.exists() || !imageFormiko.isDirectory()){
      imageFormiko.mkdir();
    }
    File langue = new File("data/langue");
    ...
    if(listi.length<nbrDImage){
      f = new File("data/imageFormiko/null.png");
      if(!f.exists() || f.isDirectory()){

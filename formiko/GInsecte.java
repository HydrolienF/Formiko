...
// Fonctions propre -----------------------------------------------------------
  ...
  public void retirer(Creature i){ try {retirerInsecte((Insecte)i);}catch (Exception e) {erreur.erreur("Impossible de retirer la créature "+i.getId()+" car ne n'est pas un insecte.","GInsecte.retirer");}}

...
public class Options {
  ...
  public void setLangue(byte x){langue=x;} public void setLangue(int x){setLangue((byte)x);}
  ...
  public void setNbrMessageAfficher(int x){ nbrMessageAfficher=(byte)x;}
  ...
  public void setBordureBouton(int x){bordureBouton=(byte)x;}

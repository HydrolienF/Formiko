...
public class GIndividu {
  ...
  public void afficheToi(){
    if(début == null){ erreur.erreur("Impossible d'afficher une liste vide","GIndividu.afficheToi");return;}
    System.out.println("Groupe d'Individu :");
    début.afficheToi();
  }

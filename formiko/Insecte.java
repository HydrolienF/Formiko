...
public class Insecte extends Creature{
  private int nourritureFournie;
  private byte nourritureMangeable;
  private byte type;
  private static GIEspece gie;
  // CONSTRUCTEUR -----------------------------------------------------------------
  // Principal
  public Insecte (CCase p, int nourritureFournie, int age, int ageMax, int actionMax){
  ...
  public Insecte (CCase p){
    this(p,10 + allea.getAlléa(101), 0,10 + allea.getAlléa(101), allea.getAlléa(21));//action entre 0 et 20.
  }
  ...
  public String toString(){
    ...
    String sr = "L'insecte "+id+ m +" de type "+type+" est en "+p.getPoint()+". Il fournira " + nourritureFournie + " nourriture, sa nourriture = "+nourriture+"/"+nourritureMax;
    return sr;
  }

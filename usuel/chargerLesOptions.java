...
public class chargerLesOptions {
  ...
  public static Options chargerLesOptions(){
    ...
    //ts[0]="version compatible";ts[1]="langue";ts[2]="taille bouton zoom";ts[3]="taille bouton action"ts[4]="taille bouton tint";
    ...
    try {
      File dossier = new File("data/imageFormiko/temporaire");
      ...
      erreur.erreur("le dossier data.imageFormiko/temporaire n'existe pas.");
    }
    return op;
  }
  public static void chargerLesOptionsDe0(int langue, String pseudo){
    ...
    volSon:100
    """);
    //@a la musique est temporairement désactivé.

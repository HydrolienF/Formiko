...
import fr.formiko.usuel.conversiondetype.*;
...
public class decoderUnFichier {
  ...
  public static int getIntDeLaLigne(String s){
    ...
    try {
      ...
      erreur.alerte(g.get("decoderUnFichier",1,"la chaîne de caractère")+" \"" + s + "\" "+g.get("decoderUnFichier",2,"n'est pas un nombre"),"decoderUnFichier.getIntDeLaLigne");
    }
    return -1;
  }

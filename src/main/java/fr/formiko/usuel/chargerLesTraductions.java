...
public class chargerLesTraductions {
  ...
  */
  public static boolean iniTLangue(){
    try {
      String t []=lireUnFichier.readFileArray(rep+"langue.csv");
  ...
  */
  public static String [] getTableauDesTrad(int langue){
    //String tDéfaut [] = lireUnFichier.readFileArray(rep+"fr.txt");
    String t [] = new String[0];
    try{
      debug.débogage("chargement de la langue "+getLanguage(langue));
      t=lireUnFichier.readFileArray(rep+getLanguage(langue)+".txt");
    }catch (Exception e) {
      erreur.erreur("Echec du chargement de la langue spécifiée","en choisi par défaut");
      t=lireUnFichier.readFileArray(rep+"en.txt");
    }
    return t;
  }
  /**
  ...
  */
  public static String []getTableauDesNationsName(){
    String t [] = new String[0];
    try{
      t=lireUnFichier.readFileArray("docs/cc/"+"nationsName"+".csv");
    }catch (Exception e) {
  ...
  */
  public static String [] getTableauDesCmd(){
    ...
    try{
      ...
      t=lireUnFichier.readFileArray(rep+"cmd"+".txt");
    }catch (Exception e) {

...
public class ChasseGranivoreTest extends TestCaseMuet{
  ...
  public static Fourmi ini(){
    Main.initialisation();
    Partie p = new Partie(0,100,new Carte(new GSquare(2,5),0,0,1,false,false),1);
    Main.setPartie(p);
    ...
    f.setCSquare(0,0);
    f.getFere().setCSquare(Main.getCSquare(0,1));
    return f;
  }
  @Test
  ...
  public void testChasse(){
    ...
    f = ini();
    f.setAction(f.getMaxAction());
    g1 = new Graine(Main.getGc().getCSquare(0,0),100,(byte)10);
    assertEquals(1,f.getCSquare().getContent().getGg().length());
    f.chasse();
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(g1,f.getTransported());
    assertEquals(null,g1.getCSquare());
    ...
    assertEquals(Main.getGc().getCSquare(0,0),g1.getCSquare());
  ...
  public void testChasse2(){
    ...
    f.setAction(f.getMaxAction());
    new Graine(Main.getGc().getCSquare(0,0),100,(byte)10);
    Graine g2 = new Graine(Main.getGc().getCSquare(0,0),105,(byte)10);
    assertEquals(2,f.getCSquare().getContent().getGg().length());
    f.chasse();
    assertTrue(f.getAction()<f.getMaxAction());
  ...
  public void testChasse3(){
    ...
    f.setAction(f.getMaxAction());
    Graine g1 = new Graine(Main.getGc().getCSquare(0,0),100,(byte)10);
    new Graine(Main.getGc().getCSquare(0,0),10,(byte)10);
    assertEquals(2,f.getCSquare().getContent().getGg().length());
    f.chasse();
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(g1,f.getTransported());
  ...
  public void testChasse5(){
    ...
    f.setAction(f.getMaxAction());
    new Graine(Main.getGc().getCSquare(0,0),105,(byte)10);
    new Graine(Main.getGc().getCSquare(0,0),100,(byte)10);
    assertEquals(2,f.getCSquare().getContent().getGg().length());
    Graine col = f.getCSquare().getContent().getGg().getFirst();
    f.chasse();
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(col,f.getTransported());
    assertEquals(1,f.getCSquare().getContent().getGg().length());
    assertTrue(!f.getCSquare().getContent().getGg().contains(col));
  }
  @Test
  ...
  // 1 seed to get on the same Square.
  @Test
  ...
  // 1 seed to get on an other Square.
  @Test
  ...
  public void testChasser3b(){
    ...
    f.getFere().getJoueur().setIa(false);
    f.setAction(f.getMaxAction());
    Graine g1 = new Graine(Main.getGc().getCSquare(0,1),100,(byte)10);
    new Graine(Main.getGc().getCSquare(0,0),105,(byte)10);
    f.chasser(8);
    assertTrue(f.getAction()<f.getMaxAction());
  ...
  public void testChasser4(){
    ...
    f.setAction(f.getMaxAction());
    new Graine(Main.getGc().getCSquare(0,0),100,(byte)10);
    new Graine(Main.getGc().getCSquare(0,2),105,(byte)10);
    f.chasser(8);
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(Main.getGc().getCSquare(0,2),f.getCSquare());
    assertEquals(null,f.getTransported());
  }
  ...
  public void testChasser6b(){
    ...
    Main.setDifficulté(0);
    f.setAction(f.getMaxAction());
    new Graine(Main.getGc().getCSquare(1,1),105,(byte)10);
    new Graine(Main.getGc().getCSquare(0,2),100,(byte)10);
    f.chasser(8);
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(Main.getGc().getCSquare(0,2),f.getCSquare()); //0,2 is before in GGraine
    assertEquals(null,f.getTransported());
  }
  ...
  public void testChasser8(){
    ...
    f.chasser(6);
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(Main.getGc().getCSquare(1,1),f.getCSquare());
    assertEquals(null,f.getTransported());
  }
  @Test
  public void testChasser9(){
    ...
    f.chasser(9);
    assertTrue(f.getAction()<f.getMaxAction());
    assertEquals(Main.getGc().getCSquare(1,2),f.getCSquare());
    assertEquals(null,f.getTransported());
  }
  ...
  public void testCanEatSeed0(){
    ...
    f.setTransported(new Graine(Main.getGc().getCSquare(0,0),105,(byte)10));
  ...
  public void testCanEatSeed6(){
    Fourmi f = ini();
    f.setHardnessMax((byte)20);
    Graine g = new Graine(Main.getGc().getCSquare(0,0),105,(byte)10);
    g.setOpen(true);
    f.setTransported(g);
    assertTrue(((ChasseGranivore)(f.chasse)).canEatSeed());
  }
  ...
  public void testEatSeed2(){
    ...
    Graine g = new Graine(Main.getGc().getCSquare(0,0),gfood,(byte)10);
    f.setTransported(g);
    f.chasse.eatSeed();

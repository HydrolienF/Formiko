...
public class imageTest extends TestCaseMuet {
  ...
  public void testTaille(){
    ...
    //Images.taille(taille de l'espece, taille voulu avec le niveau de grossicement)
    Main.getOp().setRealisticSize(100);//un paramètre utilisé par Images.taille
    assertEquals(100,Images.taille(100,100));//normale.

    //si la taille n'est pas réaliste on prend a 100% la taille de la case.
    Main.getOp().setRealisticSize(0);//un paramètre utilisé par Images.taille
    assertEquals(100,Images.taille(20,100));
    assertEquals(140,Images.taille(20,140));
    assertEquals(10,Images.taille(20,10));
    ...
    assertEquals(20,Images.taille(20,100));
    assertEquals(30,Images.taille(20,150));
    assertEquals(10,Images.taille(20,50));
    assertEquals(4,Images.taille(8,50));
    //et ca arrondi bien.
    assertEquals(4,Images.taille(8,51));
    assertEquals(4,Images.taille(8,56)); // la conversion qu'on fait ne prend que la partie entière, c'est pas très grave mais s'est bon a savoir.
    //assertEquals(5,Images.taille(8,57));
    //assertEquals(5,Images.taille(8,60));
  }
  @Test
  public void testTaillePartiellementRealiste(){
    ...
    assertEquals(75,Images.taille(50,100));//100% réaliste ca donne 100 0% réaliste ca donne 50, on veut que ce soit au milieux.
    assertEquals(60,Images.taille(50,80));
    assertEquals(150,Images.taille(50,200));
    assertEquals(72,Images.taille(20,120));

    Main.getOp().setRealisticSize(10);
    assertEquals(95,Images.taille(50,100));
    assertEquals(47,Images.taille(50,50));
    Main.getOp().setRealisticSize(63);
    assertEquals(82,Images.taille(50,120));
    assertEquals(59,Images.taille(20,120));
  }

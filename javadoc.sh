...
javadoc --allow-script-in-comments -encoding "utf-8" -docencoding "utf-8" -windowtitle "Javadoc of Formiko" -doctitle "Javadoc of Formiko" -version -quiet -author -private -d docs/javadoc/ $(find src/main/java -name "*.java" | grep -v fr/formiko/usuel/tests/) -locale en_US -stylesheetfile docs/javadoc/styles.css -header '
<ul id="buttons-bar">
